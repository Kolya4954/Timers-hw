...
const timer = setInterval(()=>{
    ...
    if (time === 30) alert("\u043B\u0438\u0448\u0438\u043B\u0430\u0441\u044C \u043F\u043E\u043B\u043E\u0432\u0438\u043D\u0430 \u0447\u0430\u0441\u0443");
    else if (time === 0) {
        clearInterval(timer);
        alert("\u0447\u0430\u0441 \u0432\u0438\u0439\u0448\u043E\u0432!");
    }
...
function startTimer() {
    ...
    id = setInterval(()=>{
        totalSeconds -= 10;
        if (totalSeconds <= 10000) divRef.style.backgroundColor = '#ff0000';
        if (totalSeconds <= 0) {
            totalSeconds = 0;
            id = null;
            clearInterval(id);
...
},{}]},["iUuJv","fILKw"], "fILKw", "parcelRequireb977", {})

//# sourceMappingURL=Timers-hw.1fcc916e.js.map
